...
| # | 항목 | 현재 상태(기본값) | 검토 포인트 |
|---|---|---|---|
| 1 | **end-of-turn 확정 지연** | vid_0001 2.46s / vid_0033 2.13s | 이상(~1–2s)보다 약간 큼. eval-tail 생성이 지배 → eval 스트리밍 / max_tokens 축소 / 턴 끝 직전 완성 평가윈도우 있으면 eval-tail 스킵으로 단축 가능. **목표치 합의 필요.** |
